 ...
 */
public class DropOffContainerAdapter extends FragmentStatePagerAdapter implements TimePickerAdapter {
    private  List<Fragment> mFragments = new ArrayList<>();
    protected  List<String> mFragmentTitles;

    public DropOffContainerAdapter(FragmentManager fm) {
        super(fm);
    ...
    public void addMultiFragment(ArrayList<String> titles, TimePickerFragment.OnItemSelectedListener onItemSelectedListener) {
        for(String title : titles) {
            ...
            timePickerFragment.init(title, Constants.FRAGMENT_DROPOFF_TIME, onItemSelectedListener);
